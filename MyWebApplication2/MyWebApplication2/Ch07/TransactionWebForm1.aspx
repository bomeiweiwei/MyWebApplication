<%@ Page Title="" Language="C#" MasterPageFile="~/Ch07/Ch07MasterPage.master" AutoEventWireup="true" CodeBehind="TransactionWebForm1.aspx.cs" Inherits="MyWebApplication2.Ch07.TransactionWebForm1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderContent" runat="server">
    <h3>使用sql command and BeginTransaction</h3>
