...
{
    public partial class Ch11_Master_Detail_UC : System.Web.UI.Page
    {
        ...
        {
            Session["gdindex"] = Convert.ToInt32(GridViewMaster.SelectedIndex.ToString());
            GridViewMaster.DataBind();
        }

        protected void GridViewMaster_RowCreated(object sender, GridViewRowEventArgs e)
        {
            ...
            int user_selected = Convert.ToInt32(Session["gdindex"]);//GridViewMaster.SelectedIndex.ToString());
            ...
            if (e.Row.RowType == DataControlRowType.Header)
            {
                ...
                e.Row.Cells[3].Text = "內容(合併表頭)";  //==標題文字==
                e.Row.Cells[3].ColumnSpan = 2;       //==左右合併2個格子==
                //------------------------------------------------------------------------------------------------------------------
                ...
                //headerCell_1.Text = "<font size=5>標題一</font> ";    //==標題標題文字==
                //headerCell_1.ColumnSpan = 2;      //==左右合併4個格子==
            ...
            if (user_selected >= 0 & e.Row.RowType == DataControlRowType.Pager)
            {
                ...
                if (Page.IsPostBack)
                {
                    ...
                    my_uc = (UserControl)LoadControl("~/Ch11/UC_Folder/Ch11_Detail_UC.ascx");
                    ...
                    myRow.Visible = true;
                    GridViewMaster.Controls[0].Controls.AddAt((user_selected + 2), myRow);
        ...
        protected void GridViewMaster_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
        {
        ...
        protected void GridViewMaster_Sorting(object sender, GridViewSortEventArgs e)
        {
            Session["gdindex"] = -1;
            GridViewMaster.SelectedIndex = -1;
            GridViewMaster.DataBind();
